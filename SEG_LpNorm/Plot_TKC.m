...
model2 = 'Tile1_MAG3D_Mix_iter5.sus';
...
DO27_UTM = [557350 7133675];
DO18_UTM = [557287 7134430];
...
DO27_UTM = DO27_UTM - [xn(1) yn(1)];
DO18_UTM = DO18_UTM - [xn(1) yn(1)];
...
set(figure, 'Position', [50 50 900 900]);
ax = axes('Position',[0.125 0.15 .4 .4]);
...
set(ylabh,'Position',get(ylabh,'Position') - [100 0 0.00]);
...
% Add DO27 marker
scatter3(DO27_UTM(1),DO27_UTM(2),450,50,'o','r','MarkerFaceColor','r')
text(DO27_UTM(1)+100,DO27_UTM(2)+100,'$DO27$','interpreter', 'latex','FontSize',12,'Color','w');

scatter3(DO18_UTM(1),DO18_UTM(2),450,50,'o','r','MarkerFaceColor','r')
text(DO18_UTM(1)+100,DO18_UTM(2)+100,'$DO18$','interpreter', 'latex','FontSize',12,'Color','w');

text(1600,-50,'(a)', 'interpreter', 'latex','FontSize',14);
...
% Add color bar
%%
ax = axes('Position',[0.21 -.05 .2 .2]);
colormap(ax,cmap1);
cbar = colorbar('NorthOutside');
set(cbar,'Ticks',[0 1])
set(cbar,'TickLabels',round([min(data_interp(:)) max(data_interp(:))]*100)/100)
set(gca,'Visible','off');
text(1.1,1.25,'$nT$', 'interpreter', 'latex','FontSize',12)
...
ax = axes('Position',[0.55 .15 .4 .4]);

m1 = load([work_dir '\' norm_vec]);
m1 = reshape(m1(:,1),nz,nx,ny);

m2D = get_model_top(m1,nx,ny,nz,-100,lvl(1));
...
% Add DO27 marker
scatter3(DO27_UTM(1),DO27_UTM(2),450,50,'o','r')
text(DO27_UTM(1)+100,DO27_UTM(2)+100,'$DO27$','interpreter', 'latex','FontSize',12);

scatter3(DO18_UTM(1),DO18_UTM(2),450,50,'o','r')
text(DO18_UTM(1)+100,DO18_UTM(2)+100,'$DO18$','interpreter', 'latex','FontSize',12);

text(1600,-50,'(b)', 'interpreter', 'latex','FontSize',14);

%%
ax = axes('Position',[0.64 -.05 .2 .2]);
colormap(ax,cmap2);
cbar = colorbar('NorthOutside');
set(cbar,'Ticks',[0 0.5 1])
set(cbar,'TickLabels',round([0 1 2]*100)/100)
set(gca,'Visible','off');
text(1.1,1.25,'$l_p$', 'interpreter', 'latex','FontSize',12)
...
% Get top of model
    ...
    text(1600,200,'(a)', 'interpreter', 'latex','FontSize',14);
    %% Get top of model
...
%     set(get(gca,'YLabel'),'Rotation',360);
    ...
    text(1750,200,'(b)', 'interpreter', 'latex','FontSize',14);
    %% Add color bar
    %%
    ax = axes('Position',[0.42 -.06 .2 .2]);
    colormap(ax,cmap);
    cbar = colorbar('NorthOutside');
    set(cbar,'Ticks',[0 0.5 1])
    set(cbar,'TickLabels',round([0 medcol maxcol]*100)/100)
    set(gca,'Visible','off');
    text(1.1,1.25,'$\kappa \;(SI)$', 'interpreter', 'latex','FontSize',12)
