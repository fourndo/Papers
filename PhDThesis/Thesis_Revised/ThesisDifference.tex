...
%DIF DEL Thesis_Driver.tex                       Fri Sep  6 13:05:30 2019
%DIF ADD ..\Thesis_Submitted\Thesis_Driver.tex   Tue Jul  2 11:51:38 2019
...
\previousdegree{MSc Geophysics, The University of British Columbia, November 2015}
...
%DIF <  Lay summary
\DIFdelbegin %DIFDELCMD < \include{summary}
...
\include{Chap1_Intro}
\include{Chap2_Forward}
\include{Chap3_Inverse}
\include{Chap4_MVIS}
\include{Chap5_RotatedGradients}
\include{Chap6_Learning}
\include{Chap7_Kevitsa}
...
\DIFdelbegin %DIFDELCMD < \bibliography{../../reference}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{../reference}
\DIFaddend \bibliographystyle{seg}
